...
class Visualizer extends React.Component {
    ...
    render() {
        ...
        //     delay += 15;
        //     return <Bar amplitude={val} aniDelay={delay} aniDur={((8 * 1000))} />
        // });
            ...
            <div id="visualizer">
                ...
                <div className="eyewrap">
                    ...
                    <div className="bawrap">
                        <div className="bars-wrapper-upside-down-inverted">
                            {/* <div id="inverted-bars" className="flip">
                                {invertedBars}
                            </div> */}

                            <div id="inverted-bars" className="unflip">
                                {invertedBars}
                            </div>
                        </div>
                    ...
                    <div className="bawrap flip-down">
                        <div className="bars-wrapper-upside-down-inverted">
                            {/* <div id="inverted-bars" className="flip">
                                {invertedBars}
                            </div> */}
...
function Bar({ amplitude, aniDelay, aniDur, isPlay }) {
    return <div className="bar" style={{ height: amplitude + '%', animationPlayState: (isPlay ? "running" : "paused"), animationDelay: aniDelay + "ms", animationDuration: aniDur + "ms" }}></div>
}
